...
public interface UriApi {
    ...
    @ApiOperation(value = "Assigns the name of a redirection", nickname = "changeURI", notes = "Assigns the name of a redirection", response = URIItem.class, tags={ "F3", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Name has been assigned successfully", response = URIItem.class),
        @ApiResponse(code = 400, message = "Error creating resource") })
    @RequestMapping(value = "/uri/{name}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.PUT)
    ResponseEntity<URIItem> changeURI(@ApiParam(value = "Optional description in *Markdown*" ,required=true )  @Valid @RequestBody URIUpdate body,@ApiParam(value = "",required=true) @PathVariable("name") String name);


    @ApiOperation(value = "Creates a name of a redirection", nickname = "changeURI", notes = "Assigns the name of a redirection", response = URIItem.class, tags={ "F3", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Creates a new redirection", nickname = "createURI", notes = "Create a new URI redirection ", response = URIItem.class, tags={ "F0","F1","F4","F5", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Deletes an existing URI and its content.", nickname = "deleteURI", notes = "Remove a URI redirection ", tags={ "F0", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> deleteURI(@ApiParam(value = "",required=true) @PathVariable("id") String id,@NotNull @ApiParam(value = "", required = true) @Valid @RequestParam(value = "hashpass", required = true) String hashpass);


    @ApiOperation(value = "Returns the data of a redirection", nickname = "getURI", notes = "Get a URI redirection ", tags={ "F0","F2","F5", })
    @ApiResponses(value = { 
